...
export {
  ...
  SystemAdminAdminController,
} from "./admin/controllers/system-admin-admin.controller";
export {
...
export { systemAdminStaffController, SystemAdminStaffController } from "./staff/controllers/system-admin-staff.controller";
export { systemAdminStaffService, SystemAdminStaffService } from "./staff/services/system-admin-staff.service";
...
export { systemAdminParentController, SystemAdminParentController } from "./parent/controllers/system-admin-parent.controller";
export { systemAdminParentService, SystemAdminParentService } from "./parent/services/system-admin-parent.service";
export { SYSTEM_ADMIN_PARENT_MESSAGES } from "./parent/constants/messages";

export { systemAdminStudentRoutes } from "./student/routes/system-admin-student.routes";
export { systemAdminStudentController, SystemAdminStudentController } from "./student/controllers/system-admin-student.controller";
export { systemAdminStudentService, SystemAdminStudentService } from "./student/services/system-admin-student.service";
export { SYSTEM_ADMIN_STUDENT_MESSAGES } from "./student/constants/messages";
