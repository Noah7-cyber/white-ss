...
try {
  // Initialize Firebase using a placeholder config - the sender ID is usually all that matters for the background worker
  // but it's better to fetch from url query if possible.
  firebase.initializeApp({
    // Add dummy config so it doesn't crash, actual config should match web app
