...
export function useTransactions(classroomId?: number | null, startDate?: string, endDate?: string) {
    ...
    const tableData = summaryData.map((item: SummaryRow) => ({
        ...
        date: dateFormatter(item.paymentDate),
        description: item.description || 'N/A',
        amount: <CashViewer amount={item.amountPaid} />,
    }));
