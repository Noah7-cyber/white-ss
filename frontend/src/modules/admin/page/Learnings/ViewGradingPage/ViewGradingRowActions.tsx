...
type ViewGradingRowActionsProps = {
  // row?: ViewGradeStudent;
  onEditObservation: () => void;
};

export default function ViewGradingRowActions({  onEditObservation }: ViewGradingRowActionsProps) {
        ...
        >
          <Box className="flex flex-col gap-3 py-1.5 !text-base w-full">
            <button
              ...
              onClick={wrap(onEditObservation)}
            >
              Edit 
            </button>
