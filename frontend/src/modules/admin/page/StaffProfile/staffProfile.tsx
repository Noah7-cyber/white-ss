...
import { useStaffProfile } from "./hook/useStaffProfile";
      ...
      <DataRenderer isLoading={isLoading}>
        {() => (
          <Box className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <Box className="flex flex-col items-center gap-4 w-full">
                <Box className="flex flex-col items-center gap-2 w-full pb-6 border-b border-[#D9E6E8]">
                  <Box className="relative">
                    ...
                    >
                      {!staffPhoto && <ProfileIcon className="w-[100px] h-[100px]" />}
                    </Avatar>
                  </Box>
            ...
            <Box className="col-span-2 flex flex-col bg-white max-h-none md:max-h-[380px] px-0 pb-0 pt-1 md:p-6 rounded-none border-0 md:rounded-md md:border md:border-brandColor-active/20 space-y-4 overflow-visible md:overflow-y-auto">
              <Box>
