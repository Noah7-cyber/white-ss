...
import NotificationIcon from "@/modules/shared/assets/svgs/notificationOutline.svg";
...
interface ParentProfilePopoverProps {
  open: boolean;
...
export const ParentProfilePopover: React.FC<ParentProfilePopoverProps> = ({
  open,
  anchorEl,
  onClose,
  user,
  onProfileClick,
  onChangePasswordClick: _onChangePasswordClick,
