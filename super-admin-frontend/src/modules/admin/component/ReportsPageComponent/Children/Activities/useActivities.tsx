...
export function useActivities(classroomId?: number | null, startDate?: string, endDate?: string) {
  ...
  const tableData = summaryData.map((item: SummaryRow) => ({
    ...
    date: dateFormatter(item?.dateTime, 'D MMM, YYYY h:mm A'),
    activityType: item?.activityType,
    description: item?.notesOrDescription || 'N/A',
  }));
