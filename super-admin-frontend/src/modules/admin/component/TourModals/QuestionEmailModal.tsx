...
export default function QuestionEmailModal({ isOpen, onClose, onSave }: QuestionModalProps) {
        ...
        <div className="space-y-4 mt-4">
          ...
          <div>
            <CWTextField
              ...
              label="Require emails that contain"
              labelClassName="!text-sm !font-medium !text-input-gray"
              labelOnTop
              inputClasses="mt-1 !text-sm !h-10"
            />
          ...
          <div>
            <CWTextField
              ...
              name="exclude"
              placeholder="gmail.com, hotmail.com, ..."
              label="Exclude emails that contain"
              labelClassName="!text-sm !font-medium !text-input-gray"
              labelOnTop
              inputClasses="mt-1 !text-sm !h-10"
            />
          ...
          <div className="flex justify-end gap-3 mb-4">
            ...
            <button className="px-9 py-2 rounded-lg bg-[#007C79] text-white">Save</button>
          </div>
        </div>
      </form>
    </Modal>
