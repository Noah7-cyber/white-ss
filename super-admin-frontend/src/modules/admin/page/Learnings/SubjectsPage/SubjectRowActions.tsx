...
type SubjectRowActionsProps = {
  subject: SubjectRow;
  onView?: (subject: SubjectRow) => void;
  onEdit: (subject: SubjectRow) => void;
  onDelete?: (subject: SubjectRow) => void;
};

export default function SubjectRowActions({
  subject,
  onView,
  onEdit,
  onDelete,
